        ...
        <title>JSP Page</title>
         <script>
            ...
            function view()
            {
                ...
                // Step 2
                xhttp.open("GET", "./admin_view_freelancers", true);    // true --> async request
...
//                                    alert("in loop");
            ...
            function cancel(index)
            {
                ...
                xhttp.open("GET", "./freelancer_status_servlet?bid2="+index, true);    
    ...
    <body onload="view()">
        ...
        <br>
        <br>
        <h1 style="color: white"> Freelancers</h1>
   ...
   <br>
                ...
                <div class="d12" style="display:block;" id="d12">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" style="color:#dc3545" data-dismiss="modal">Close</button>
                                </div>
