  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	          ...
	          <li class="nav-item active"><a href="ClientHome.jsp" class="nav-link">Home</a></li>
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item"  href="ClientTechSearch.jsp">Search by Technology</a>
        <a class="dropdown-item" href="ClientUserSearch.jsp">Search by Username</a>
