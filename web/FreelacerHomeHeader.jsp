...
<!--                  <li class="nav-item dropdown">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="searchByUser.jsp" style="cursor:pointer;">Username</a>
        <a class="dropdown-item" href="searchByTechnology.jsp" style="cursor:pointer;">Technology</a>
   
<!--        <a class="dropdown-item" onclick="searchJobsByBackEnd()" style="cursor:pointer;" >Back End</a>-->
