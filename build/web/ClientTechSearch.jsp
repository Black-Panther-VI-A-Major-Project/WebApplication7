        ...
        <br>  
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <center> <h1 class="h1">Search By Technology</h1></center>
...
<!--              <form id="form1" method="post" enctype="multipart/form-data" >-->
  ...
  <div class="form-group form-row" >
                            <label for="search-box" class="col-sm-3">Technology</label>
    ...
    <script>
       ...
       function clear(e){
           ...
           if(key==8 || key==46){
             if(text.length<1){
               console.log("empty");
                document.querySelectorAll('.skills').forEach(function(task){
...
//                         ans = ans+"<td width=\"20%\"><img src=\""+ singleobj["photo"] +"\" width='110' height='100' /></td>";
 ...
 ans=ans+"<td width=\"50%\"><h2>skills</h2> <br> <h5 class=\"skills\" > Languages: "+singleobj["programminglanguage"]+"</h5> <br> <h5 class=\"skills\"> Frontend: "+singleobj["frontend"]+"</h5> <br> <h5 class=\"skills\"> Backend: "+singleobj["backend"]+"</h5></td>";
