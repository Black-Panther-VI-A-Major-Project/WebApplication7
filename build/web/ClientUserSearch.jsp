    ...
    <script>
       ...
       function clear(e){
           ...
           if(key==8 || key==46){
             if(text.length<1){
               console.log("empty");
                document.querySelectorAll('.freelancer-email').forEach(function(task){
...
//                         ans = ans+"<td width=\"20%\"><img src=\""+ singleobj["photo"] +"\" width='110' height='100' /></td>";
                        ...
                        ans=ans+"<td width=\"50%\"><h2>"+singleobj["projectname"]+"</h2> <br> <h5 class=\"freelancer-email\">"+singleobj["emailid"]+"</h5> <br> <h5>"+singleobj["projecttechnologies"]+"</h5> <br> <h5>"+singleobj["timeframe"]+"</h5></td>";
...
//                         ans = ans+"<td width=\"20%\"><img src=\""+ singleobj["photo"] +"\" width='110' height='100' /></td>";
                ...
                ans=ans+"<td width=\"50%\"><h2 class=\"freelancer-email\">"+singleobj["emailid"]+"</h2> <br> <h5 class=\"client-email\"> experience: "+singleobj["experience"]+"</h5> <br> <h5 class=\"jobs-techs\"> certifications: "+singleobj["certification"]+"</h5> <br></td>";
 ans=ans+"<td width=\"50%\"><h2>skills</h2> <br> <h5 > Languages: "+singleobj["programminglanguage"]+"</h5> <br> <h5 class=\"jobs-techs\"> Frontend: "+singleobj["frontend"]+"</h5> <br> <h5 class=\"jobs-techs\"> Backend: "+singleobj["backend"]+"</h5></td>";
      
                
 //      ans+="<td width=\"40%\"> <h4>Description</h4><h5>"+singleobj["discreption"]+"</h5></td>";
                        //  ans = ans+"<td>"+"<img src=\""+ singleobj["photo_cover"] +"\" width='100' height='100' />"+"</td>";
                        //   ans = ans+"<td>"+"<img src=\""+ singleobj["photo_profile"] +"\" width='100' height='100' />"+"</td>";
                          ans=ans+"<td width=\"10%\">"+"<input type=\"button\" value=\"Message\" class=\"btn-outline-primary2\" onclick=\"updateCart("+singleobj["food_item_id"]+")\"/>"+"</td>";
                        ans=ans+"</tr>";
                        ans=ans+"</table>";
...
//********************
                ...
                // Step 2
                 xhttp.open("GET", "./get_all_freelancers", true);    // true --> async request
